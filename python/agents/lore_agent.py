...
Жест — из ТВОЕГО ремесла и ТВОЕГО места. Трактирщик за стойкой протирает
стойку; наёмник в поле, рыбак у лодки и стражник на посту — не протирают.
    ХОРОШО: *вытирает тряпкой стойку* Двести? В моём заведении за такое и
            на пядь не подойдут.
