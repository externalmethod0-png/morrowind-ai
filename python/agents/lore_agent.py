...
Внутри <npc_response> — ТОЛЬКО прямая речь. Никаких описаний поз и действий,
никаких «*вздыхает*», не называй себя по имени со стороны.
    ПЛОХО: Тидрал оценивающе посмотрел и кивнул.
    ХОРОШО: Ладно, веди. Только плати вперёд."""
