...
POOL_HZ = {"dm": 86.0, "im": 136.1, "df": 158.7, "if": 181.1,
           # Дообученные пулы. ВАЖНОЕ НАБЛЮДЕНИЕ: они НЕ попали в высоту своей
           # расы. Аргонианка вышла 184 Гц против 235 у родной озвучки,
           # аргонианин 78 против 91 — потому что дообучение шло с русского
           # базового голоса, а материала всего 8-12 минут: тембр перенялся
           # частично, высота осталась близко к базовой. Хаджит попал почти
           # точно, 119.5 против 113.
           #
           # Значит поправка по высоте нужна и для своих пулов — но теперь она
           # ложится на СВОЙ тембр, а не на чужой имперский. Это и было целью.
           "am": 78.3, "af": 184.1, "km": 119.5}
