...
class OpenMWLogBridge:
    ...
    GOALS_BY_TRADE = {
        "merchant": [
            ...
            "выучить сына делу, пока тот не сбежал в матросы",
            "выжить соседа-конкурента не деньгами, а репутацией",
            "достать редкий товар, о котором давно просил один человек",
        ],
        "guard": [
            ...
            "поймать наконец того карманника, что дразнит весь квартал",
            "не дать новичку в отряде наделать глупостей",
            "разобраться, кто пишет доносы на своих",
        ],
        "priest": [
            ...
            "уговорить одну упрямую душу вернуться в храм",
            "дописать труд, который начал ещё наставник",
            "простить того, кого простить не выходит",
        ],
        "warrior": [
            ...
            "выучить ученика, чтобы было кому оставить ремесло",
            "доказать, что отставка была несправедливой",
            "дойти до Красной горы и вернуться живым — просто чтобы смочь",
        ],
        "thief": [
            ...
            "вытащить друга из ямы, в которую сам его втянул",
            "узнать, кто сдал их прошлое дело",
            "уговорить сестру не идти по той же дорожке",
        ],
        "commoner": [
            ...
            "починить крышу до дождей — руки нужны, а не деньги",
            "разыскать человека, который умеет читать по-древнему",
            "помириться с братом, с которым не говорит третий год",
            "выучиться грамоте, пока не поздно",
        ],
    }
    FEARS = [
