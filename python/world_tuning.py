...
# По умолчанию мир спокойный. Тридцать оказалось слишком для начала игры:
# человек только заходит, хочет осмотреться и развиваться, а на него уже
# нападают и сажают. Десять — фон, а не события каждые пять минут; кому нужно
# погорячее, крутит ручку сам.
DEFAULTS = {"опасность": 10, "нелепость": 10}
